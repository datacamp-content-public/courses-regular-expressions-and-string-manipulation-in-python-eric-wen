...
`@script`
I thought it would be helpful to include a few slides to cover some prerequisite material that would have been introduced in earlier lessons.  Then, we will cover the main topic in this chapter: In this brief section we will begin with a quick review of the
...
_output:_
     ...
     `Adele       False     None
      Alan        True      <re.Match  object; span=(2, 4), match='an'>
      Ana-Maria   True      <re.Match object; span=(0, 2), match='An'>
      Aolani      <re.Match  object; span=(3, 5), match='Aolan'>
      Arlene      False     None`
